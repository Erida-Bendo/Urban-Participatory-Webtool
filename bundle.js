...
function func8(){
    ...
    removeMarkers();
    intro.innerHTML = "<b>Spielplätze sind ein wichtiges Umfeld für Kinder und junge Familien.</b><br> Wo werden Ihrer Meinung nach Spielplätze am meisten gebraucht? <br><br><b>Verschieben Sie die 5 Markierungen in der Karte an die gewünschten Stellen.. Danach klicken Sie auf die Schaltfläche unten, um zum nächsten Schritt zu gelangen";
...
function func10(){
    ...
    endButton.id= "button";
    endButton.onclick = () =>{
        intro.innerHTML = "Danke für Ihre Teilnahme. <br> <br><b>Ihre Daten wurden gesammelt.<b/> <br><br><br><br><i>Unter den folgenden Link können Sie mehr über Hitzeschütz und Hitzevorsorge in Deutschland lesen<i/><br/>";
